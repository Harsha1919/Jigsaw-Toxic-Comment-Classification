...
train = pd.read_csv(r"F:\Jigsaw_toxic\train.csv")
test = pd.read_csv(r"F:\Jigsaw_toxic\test.csv")
...
pickle.dump(cv, open('F:\Jigsaw_Comment_classification/tranform.pkl', 'wb'))
...
with open('F:\Jigsaw_Comment_classification/trained_model.pkl', 'wb') as f:
    pickle.dump(xgb, f) 
    
# In[54]
    
with open('F:\Jigsaw_Comment_classification/trained_model.pkl', 'rb') as f:
